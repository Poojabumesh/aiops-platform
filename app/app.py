...
request_latency = Histogram(
    "app_request_latency_seconds", "Request latency in seconds", ["endpoint", "method"]
)

error_counter = Counter(
    "app_errors_total", "Total number of errors", ["endpoint", "error_type"]
)

prediction_counter = Counter(
    "app_predictions_total", "Total number of predictions", ["prediction_type"]
)
